...
/**
 * 如果MyConguration加的是@Configuration 下面打印的是同一个对象 @Configuration(cglib代理)
 *
 *  如果MyConguration加的是@Component 下面打印的是不同的对象
 */
public class Test {
    public static void main(String[] args) {
        AnnotationConfigApplicationContext app = new AnnotationConfigApplicationContext(MyConguration.class);
